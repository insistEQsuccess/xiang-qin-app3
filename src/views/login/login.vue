  ...
  <div class="login-wraper">
    ...
    <div class="form-item">
      ...
      <div class="form-content">
        <input type="text" class="normal-input" placeholder="请填写手机号">
      </div>
    </div>
    <div class="form-item">
      <div class="form-label">
      ...
      <div class="form-content">
        <input type="text" class="normal-input" placeholder="请填写验证码">
      </div>
    </div>
  </div>
</template>
...
.login-bg-box{
  ...
  z-index: 0;
  background: url(../../assets/img/login-bg.jpg) no-repeat center center / 100% 100%;
  opacity: 0.2;
}
.login-wraper{
  position: relative;
