<template>
  <div class="info-box">
    ...
    <div class="info-item">
      ...
      <div class="item-b">
        <input readonly type="text" class="normal-input" v-model="ruleForm.area" @click="showChooseArea = true"/>
      </div>
    </div>
    <div class="info-item">
      ...
      <div class="item-b">
        <ul>
          <li><label><input type="radio" name="marriage" value="1" v-model="ruleForm.marriageStatus">未婚</label></li>
          <li><label><input type="radio" name="marriage" value="2" v-model="ruleForm.marriageStatus">离异，无子女</label></li>
          <li><label><input type="radio" name="marriage" value="3" v-model="ruleForm.marriageStatus">离异，带子女</label></li>
          <li><label><input type="radio" name="marriage" value="4" v-model="ruleForm.marriageStatus">离异，子女归对方</label></li>
          <li><label><input type="radio" name="marriage" value="5" v-model="ruleForm.marriageStatus">丧偶</label></li>
        </ul>
      </div>
    </div>
    <div class="info-item">
    ...
    <div class="info-item">
      ...
      <div class="item-b">
        <ul>
          <li><label><input type="radio" name="education" value="1" v-model="ruleForm.education">硕士及以上</label></li>
          <li><label><input type="radio" name="education" value="2" v-model="ruleForm.education">本科</label></li>
          <li><label><input type="radio" name="education" value="3" v-model="ruleForm.education">专科</label></li>
          <li><label><input type="radio" name="education" value="4" v-model="ruleForm.education">其他</label></li>
        </ul>
      </div>
    </div>
    <div class="info-item">
      ...
      <div class="item-b">
        <ul>
          <li><label><input type="radio" name="enterprise" value="1" v-model="ruleForm.enterprise">国企/央企</label></li>
          <li><label><input type="radio" name="enterprise" value="2" v-model="ruleForm.enterprise">私企</label></li>
          <li><label><input type="radio" name="enterprise" value="3" v-model="ruleForm.enterprise">自营</label></li>
          <li><label><input type="radio" name="enterprise" value="4" v-model="ruleForm.enterprise">其他</label></li>
        </ul>
      </div>
    </div>
    <div class="info-item">
      ...
      <div class="item-b">
        <ul>
          <li><label><input type="radio" name="annualIncome" value="1" v-model="ruleForm.annualIncome">10万以下</label></li>
          <li><label><input type="radio" name="annualIncome" value="2" v-model="ruleForm.annualIncome">10-30万</label></li>
          <li><label><input type="radio" name="annualIncome" value="3" v-model="ruleForm.annualIncome">30-50万</label></li>
          <li><label><input type="radio" name="annualIncome" value="4" v-model="ruleForm.annualIncome">50万以上</label></li>
        </ul>
      </div>
    </div>
    <div class="info-item">
      ...
      <div class="item-b">
        <ul>
          <li><label><input type="radio" name="housing" value="1" v-model="ruleForm.housing">一套住房</label></li>
          <li><label><input type="radio" name="housing" value="2" v-model="ruleForm.housing">两套及以上住房</label></li>
          <li><label><input type="radio" name="housing" value="3" v-model="ruleForm.housing">无住房，暂无意向买房</label></li>
          <li><label><input type="radio" name="housing" value="4" v-model="ruleForm.housing">无住房，随时可买房</label></li>
        </ul>
      </div>
    </div>
    <div class="info-item">
      ...
      <div class="item-b">
        <ul>
          <li><label><input type="radio" name="car" value="1" v-model="ruleForm.car">有车，20万以下</label></li>
          <li><label><input type="radio" name="car" value="2" v-model="ruleForm.car">有车，20万以上</label></li>
          <li><label><input type="radio" name="car" value="3" v-model="ruleForm.car">无车</label></li>
        </ul>
      </div>
    </div>
    <div class="info-item">
      ...
      <div class="item-b">
        <ul>
          <li><label><input type="radio" name="pension" value="1" v-model="ruleForm.pension">有养老金</label></li>
          <li><label><input type="radio" name="pension" value="2" v-model="ruleForm.pension">无养老金</label></li>
        </ul>
      </div>
    </div>
    <div class="info-item">
...
<script lang="ts">
  ...
  export default defineComponent({
    name: 'Info',
    setup () {
      const ruleForm = reactive<{ [k: string]: any }>({
        sex: 1,
        area: '',
        areaCode: '',
        marriageStatus: '',
        ...
        weChatOpenId: '', // 微信登录id
        qqOpenId: '', // QQ登录id
        type: '', // 登录类型：1-手机一键注册 2-微信注册 3-qq注册 4-手机验证吗注册 5-账号登陆
        ...
        cityId: '', // 市
        areaId: '', // 区
        maritalStatus: '', // 婚姻状况 5:未婚 2:离异无子女 4:离异带子女 3:离异子女归对方 1:丧偶
      ...
      function onConfirmArea (val: any) {
        console.log(val)
        ruleForm.area = val.selectedOptions.map((it: any) => it.text).join('-')
        ruleForm.areaCode = val.selectedOptions.map((it: any) => it.value)
